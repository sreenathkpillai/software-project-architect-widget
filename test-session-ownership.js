...
async function testSessionOwnership() {
  try {
    ...
    const incompleteUrl = `https://localhost:5000/widget/api/sessions/incomplete?externalId=${testExternalId1}`;
    console.log(`   - Testing: ${incompleteUrl}`);
    
    // Test completed sessions API
    const completedUrl = `https://localhost:5000/widget/api/sessions/completed?externalId=${testExternalId1}`;
    console.log(`   - Testing: ${completedUrl}`);
    
    // Test documents API with correct ownership
    const documentsUrl = `https://localhost:5000/widget/api/sessions/${testSessionId}/documents?externalId=${testExternalId1}`;
    ...
    const wrongOwnerUrl = `https://localhost:5000/widget/api/sessions/${testSessionId}/documents?externalId=${testExternalId2}`;
